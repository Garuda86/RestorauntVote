...
import ru.garuda86.graduation.util.ValidationUtil;
import ru.garuda86.graduation.util.exception.*;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;

import static ru.garuda86.graduation.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            ...
            "votes_unique_user_rest_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
